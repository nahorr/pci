  ...
  <body>
    <main>
      ...
      <div class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall" data-options='{direction: "reverse", settings_mode_oneelement_max_offset: "150"}'>
        <div class="divimage dzsparallaxer--target w-100 g-bg-cover g-bg-black-opacity-0_3--after" style="height: 120%; background-image: url(assets/img-temp/1920x1080/img1.jpg);"></div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-6 g-mb-30">
              <div class="h-100 g-bg-size-cover g-bg-pos-center g-bg-cover g-bg-black-opacity-0_4--after g-pos-rel g-py-150 g-mb-30 g-mb-0--lg" data-bg-img-src="{{asset('assets-theme/img-temp/900x600/img2.jpg')}}">
            ...
            <div class="col-sm-6 col-lg-3 g-mb-30">
              <!-- Video Article -->
              <div class="g-bg-size-cover g-bg-pos-center g-bg-cover g-bg-black-opacity-0_4--after g-pos-rel g-py-50 g-mb-30" data-bg-img-src="{{asset('assets-theme/img-temp/300x300/img2.jpg')}}">
              ...
              <!-- Video Article -->
              <div class="g-bg-size-cover g-bg-pos-center g-bg-cover g-bg-black-opacity-0_4--after g-pos-rel g-py-50 g-mb-30 g-mb-0--lg" data-bg-img-src="{{asset('assets-theme/img-temp/300x300/img3.jpg')}}">
                <article class="text-center g-pos-rel g-z-index-1 g-px-20">
                  <a class="js-fancybox d-inline-block g-text-underline--none--hover mb-3" href="javascript:;"
                     data-src="//www.youtube.com/embed/BNpiwOkKIJ8?autoplay=1"
                     data-speed="350"
      ...
      <!-- Promo Banner -->
      <div class="g-bg-img-hero g-bg-pos-top-center g-bg-size-cover g-bg-cover g-bg-white-gradient-opacity-v5--after" style="background-image: url(assets/img-temp/1920x800/img1.jpg);">
      ...
      <div class="container g-pt-100 g-pb-70">
        ...
        <div class="row">
          <div class="col-lg-6 g-mb-30">
            <!-- Article -->
            <article class="g-min-height-360 g-bg-size-cover g-pos-rel" style="background-image: url(assets/img-temp/900x600/img1.jpg);">
          ...
          <div class="col-sm-6 col-lg-3 g-mb-30">
            ...
            <article class="u-block-hover g-brd-around g-brd-gray-light-v4">
              <figure class="g-pos-rel">
                <img class="img-fluid w-100" src="{{asset('assets-theme/img-temp/400x568/img1.jpg')}}" alt="Image Description">
          ...
          <div class="col-sm-6 col-lg-3 g-mb-30">
            ...
            <article class="u-block-hover g-brd-around g-brd-gray-light-v4">
              <figure class="g-pos-rel">
                <img class="img-fluid w-100" src="{{asset('assets-theme/img-temp/400x568/img3.jpg')}}" alt="Image Description">
          ...
          <div class="col-sm-6 col-lg-3 g-mb-30">
            ...
            <article class="u-block-hover g-brd-around g-brd-gray-light-v4">
              <figure class="g-pos-rel">
                <img class="img-fluid w-100" src="{{asset('assets-theme/img-temp/400x568/img4.jpg')}}" alt="Image Description">
          ...
          <div class="col-sm-6 col-lg-3 g-mb-30">
            ...
            <article class="u-block-hover g-brd-around g-brd-gray-light-v4">
              <figure class="g-pos-rel">
                <img class="img-fluid w-100" src="{{asset('assets-theme/img-temp/400x568/img5.jpg')}}" alt="Image Description">
          ...
          <div class="col-sm-6 col-lg-3 g-mb-30">
            ...
            <article class="u-block-hover g-brd-around g-brd-gray-light-v4">
              <figure class="g-pos-rel">
                <img class="img-fluid w-100" src="{{asset('assets-theme/img-temp/400x568/img6.jpg')}}" alt="Image Description">
          ...
          <div class="col-sm-6 col-lg-3 g-mb-30">
            ...
            <article class="u-block-hover g-brd-around g-brd-gray-light-v4">
              <figure class="g-pos-rel">
                <img class="img-fluid w-100" src="{{asset('assets-theme/img-temp/400x568/img7.jpg')}}" alt="Image Description">
      ...
      <div class="container g-pb-100">
        ...
        <div id="carouselCus2" class="js-carousel u-carousel-v12"
          ...
          <div class="js-slide u-block-hover">
            <img class="mx-auto g-width-80 u-block-hover__main--grayscale g-opacity-0_5 g-opacity-1--hover g-opacity-1--active g-cursor-pointer" src="{{asset('assets-theme/img-temp/200x100/img1.png')}}" alt="Image description">
          </div>

          <div class="js-slide u-block-hover">
            <img class="mx-auto g-width-80 u-block-hover__main--grayscale g-opacity-0_5 g-opacity-1--hover g-opacity-1--active g-cursor-pointer" src="{{asset('assets-theme/img-temp/200x100/img2.png')}}" alt="Image description">
          </div>

          <div class="js-slide u-block-hover">
            <img class="mx-auto g-width-80 u-block-hover__main--grayscale g-opacity-0_5 g-opacity-1--hover g-opacity-1--active g-cursor-pointer" src="{{asset('assets-theme/img-temp/200x100/img3.png')}}" alt="Image description">
          </div>

          <div class="js-slide u-block-hover">
            <img class="mx-auto g-width-80 u-block-hover__main--grayscale g-opacity-0_5 g-opacity-1--hover g-opacity-1--active g-cursor-pointer" src="{{asset('assets-theme/img-temp/200x100/img4.png')}}" alt="Image description">
          </div>

          <div class="js-slide u-block-hover">
            <img class="mx-auto g-width-80 u-block-hover__main--grayscale g-opacity-0_5 g-opacity-1--hover g-opacity-1--active g-cursor-pointer" src="{{asset('assets-theme/img-temp/200x100/img5.png')}}" alt="Image description">
          </div>

          <div class="js-slide u-block-hover">
            <img class="mx-auto g-width-80 u-block-hover__main--grayscale g-opacity-0_5 g-opacity-1--hover g-opacity-1--active g-cursor-pointer" src="{{asset('assets-theme/img-temp/200x100/img7.png')}}" alt="Image description">
          </div>

          <div class="js-slide u-block-hover">
            <img class="mx-auto g-width-80 u-block-hover__main--grayscale g-opacity-0_5 g-opacity-1--hover g-opacity-1--active g-cursor-pointer" src="{{asset('assets-theme/img-temp/200x100/img8.png')}}" alt="Image description">
          </div>
        </div>
      </div>
      <!-- End Clients -->
